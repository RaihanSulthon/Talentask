...
const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen flex">
      {/* ── LEFT PANEL ── */}
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-center p-12 overflow-hidden bg-linear-to-br from-violet-700 via-purple-700 to-indigo-800">
        {/* Decorative blobs */}
        ...
        <div className="absolute top-10 left-1 z-20">
          <img src={logoFull} alt="TalenTask" className="h-40 w-auto brightness-0 invert" />
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-white/60 text-lg">
              TalenTask brings your tasks, approvals, and team together in one beautiful workspace.
            </p>
          </div>
        ...
        <div className="absolute bottom-8 left-12 z-20">
          <p className="text-white/40 text-xs">&copy; {new Date().getFullYear()} TalenTask. All rights reserved.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen bg-white relative">
        ...
        <div className="lg:hidden absolute top-20 left-1/2 -translate-x-1/2 z-20">
          <img src={logoFull} alt="TalenTask" className="h-56 w-auto" />
        </div>
