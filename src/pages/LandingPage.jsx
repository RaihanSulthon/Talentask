  ...
  const benefits = [
    {
      ...
      description: "Super Admins, Admins, and Interns each see exactly what they need. No information overload.",
    },
    {
      icon: "📊",
      title: "Approval Workflows",
      description: "Structured task submission and approval process keeps quality high and accountability clear.",
    },
    {
      icon: "🔔",
      title: "Real-Time Notifications",
      description: "Never miss an update. Instant notifications for task assignments, approvals, and comments.",
    },
    {
      icon: "📁",
      title: "Centralized Resources",
      description: "All docs, links, and references in one place. No more digging through emails or chats.",
    },
    {
      icon: "🤝",
      title: "Mentor-Intern Pairing",
      description: "Smart team structures that pair interns with mentors and track progress transparently.",
    },
    {
      icon: "📱",
      title: "Works Everywhere",
      description: "Fully responsive design. Manage internships from desktop, tablet, or mobile seamlessly.",
    },
  ];
    ...
    <LandingLayout>
      ...
      <section className="py-14 px-6 bg-white border-y border-gray-100">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {stats.map((stat, i) => (
            <div key={i}>
              <div className="text-4xl font-extrabold bg-linear-to-r from-blue-500 to-violet-600 bg-clip-text text-transparent">
                {stat.value}
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="group relative p-8 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-violet-200 hover:shadow-md transition-all duration-300 hover:scale-[1.02]"
              >
                <div
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500 max-w-2xl mx-auto">
              From setup to fully productive — get your entire internship program organized fast.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {steps.map((step, i) => (
              <div key={i} className="relative text-center">
                <div className={`w-20 h-20 mx-auto rounded-2xl bg-linear-to-r ${step.color} flex items-center justify-center mb-6 shadow-lg`}>
                  <span className="text-white text-2xl font-extrabold">{step.step}</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              Every feature was designed around one question: what do mentors and interns actually need?
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b, i) => (
              <div
                key={i}
                className="flex items-start gap-4 p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-colors duration-200"
              >
            ...
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full bg-linear-to-r ${t.color} flex items-center justify-center text-white text-sm font-bold`}>
                    {t.avatar}
                  </div>
                  <div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-12 bg-linear-to-r from-blue-600 to-violet-600 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed">
                Join hundreds of companies already using TalenTask to create exceptional internship experiences.
              </p>
      ...
      <footer className="py-10 px-6 bg-slate-900 text-center">
        <p className="text-slate-500 text-sm">
          © {new Date().getFullYear()} TalenTask · Built for modern internship management
        </p>
      </footer>
    </LandingLayout>
  );
